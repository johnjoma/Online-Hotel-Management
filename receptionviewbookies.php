...
<html>
  <head>
    ...
    <center>
    <div id="navbar">
  NOKRAS HOTELS <strong> Murang'a RECEPTION</strong> DASHBOARD
  ...
  <body>
    ...
    <form class="" action="receptionsearchview.php" method="post">
    ...
    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
        ...
        $result = mysqli_query($conn,"SELECT * FROM `reservations` WHERE branch='muranga' LIMIT $offset, $total_records_per_page");
