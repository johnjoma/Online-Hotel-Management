...
<html>
  ...
  <body>
    ...
    <form class="" action="bookiessearch.php" method="post">
    ...
    <th style='width:450px;background-color: #4CAF50;'>STATUS</th>
    ...
    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
        ...
        $result = mysqli_query($conn,"SELECT * FROM `reservations` LIMIT $offset, $total_records_per_page");
