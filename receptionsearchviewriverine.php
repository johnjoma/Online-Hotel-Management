...
<html lang="en" dir="ltr">
  ...
  <body>
     <a href="receptionviewbookiesriverine.php"> back</a>
...
if (isset($_POST['submit'])) {
  ...
  $enddate=$_POST['enddate'];
    ...
    $sql="SELECT * FROM reservations WHERE branch='riverine' AND datein BETWEEN '$startdate' AND '$enddate' ORDER BY datein ";
    ...
    if (isset($_POST['submit'])) {
      ...
      $sql="SELECT * FROM reservations WHERE branch='riverine' AND customer_id LIKE '%$search%' ";
