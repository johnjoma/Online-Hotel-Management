...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <br><br>
    <form class="" action="cancellationsearch.php" method="post">
<input type="text" name="search" value="" placeholder="Enter branch name">
<input type="submit" name="submit" value="Filter">
   ...
   <br><br>
    ...
    <table class="table table-striped  ">
      ...
      $sql="SELECT customer_id,branch, boardtype,status FROM reservations WHERE status='cancelled'";
